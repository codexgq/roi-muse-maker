  ...
  head: () => ({
    meta: [
      ...
      { title: "ROI SALES COMPANION — Sales Engineer's Calculator" },
      {
        name: "description",
        content:
          "Real-time, customizable ROI business cases for sales engineers. Industry templates, prospect branding, and AI-powered company research in one place.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/d843079c-efd1-4805-b804-4c03142e09c9/id-preview-7cd5e6a2--f82c87ed-172d-4a28-8eef-b000f60a5a9d.lovable.app-1784501830883.png",
      },
      {
        name: "twitter:image",
        content:
